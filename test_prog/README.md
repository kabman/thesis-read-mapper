This directory conatins a test program for mapper. First compile mapper with `N_CODE=0x4E`. To compile the test program run `make`. Running the test program without any paramters will print the options:
